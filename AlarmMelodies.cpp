...
// Night Fever
const int melodyTemp[] =   { 440, 524, 588,   0, 524, 440, 524,   0, 440, 392,   0, 440, 524,   0, 524,   0, 440, 524, 588,   0 };
const int durationTemp[] = { 200, 200, 200, 200, 200, 200, 200, 200, 200, 700, 450,  75,  75, 200,  75,  75,  75, 325,  75, 3075 };

//funky town
const int melodyHumi[] =   { 524,   0, 524,   0, 466,   0, 524,   0, 392,   0, 392,   0, 524,   0, 698,   0, 660,   0, 524,   0, 392,   0 };
const int durationHumi[] = {  75,  75,  75,  75,  75,  75,  75, 325,  75, 325,  75,  75,  75,  75,  75,  75,  75,  75,  75, 825,  75,  75 };

// We didn't start the fire
const int melodyGas[] =   { 294,   0, 294, 294, 330,   0, 392, 440, 494,   0, 330, 392, 440, 494, 440, 392, 330, 392, 440, 494, 440, 392,   0 };
const int durationGas[] = { 325,  75, 200, 200, 325,  75, 200, 450, 200, 950, 200, 200, 450, 200, 450, 200, 200, 200, 450, 200, 450, 200, 450 };

// Super mario
const int melodyWater[] =   { 524,   0, 392,   0, 330,   0, 440,  0, 494,  0, 466, 440,  0, 392,  0, 660, 784,  0, 880,  0, 698, 784,  0, 660,  0, 524, 588, 494,   0 };
